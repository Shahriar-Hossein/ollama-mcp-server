...
```json
{
  ...
  "file": "src/experimental/tools/local-explorer-task.ts",
  "language": "typescript",
  "kind": "function",
...
- `src/experimental/tools/local-explorer-task.ts`: nested functions and their parent links.
- `scripts/validate-cloud-bash.cjs`: JavaScript declarations.
- `docs/experimental/super-explorer/README.md`: no records, since Markdown is not a
