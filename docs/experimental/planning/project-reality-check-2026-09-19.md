...
Sources: [capability-matrix results](../benchmarks/runs/2026-09-16-capability-matrix-results.md), [early trials](../benchmarks/runs/2026-09-12-early-trials.md), [worker implementations](../../../src/experimental/), [Super Explorer design](../super-explorer/README.md).
...
**The gold checker is a useful smoke check, not a correctness oracle.** [gold-set-cli.ts](../../../src/experimental/benchmarks/gold-set-cli.ts) searches for substrings in the answer and citation text. It neither proves that a cited range supports a claim nor rejects all extra false claims. It can reject equivalent wording such as `120000` versus `120_000`. SE-36 currently requires all three spellings `1,600`, `1600`, and `1_600`, rather than accepting alternatives. Fix the rubric, not the model, for that case.
...
Sources: [shared client](../../../src/ollama-client.ts), [summarizer](../../../src/tools/summarize-output.ts), [local worker](../../../src/experimental/workers/run-local-worker-task.ts), [explorer](../../../src/experimental/tools/local-explorer-task.ts), [allowlist](../../../src/experimental/workers/shell-allowlist.ts), [cloud hook](../../../scripts/validate-cloud-bash.cjs), [existing backlog](improvements-backlog.md).
...
for name in ('sweep4-limit40-qwen4b', 'sweep5-limit40-qwen2b', 'sweep6-retry-limit80'):
    path = pathlib.Path('docs/experimental/benchmarks/runs') / f'2026-09-19-{name}-results.json'
